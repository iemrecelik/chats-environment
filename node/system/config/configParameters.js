...
module.exports = class configure {
	...
	constructor() {
		...
		try {
			...
			// console.log('yamlFiles ==> ', this.yamlFiles);
			// console.log('parameters ==> ', this.parameters);
			// console.log('configParameters ==> ', this.configParameters);
			// console.log('services ==> ', this.services);
			// console.log('services ==> ', this.services.runTest);
			// console.log('////////////////////////////');
			// console.log(JSON.stringify(this.yamlFiles));
